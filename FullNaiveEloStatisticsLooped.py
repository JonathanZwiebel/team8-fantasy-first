...
STRENGTH_FACTOR = 400	 		# FIDE Value scaled
ADJUSTMENT_FACTOR = 32			# FIDE Value scaled

import TBAconnection 
import math
import scipy as sp

def full_naive_elo_stats_loop(eventid, iterations):
	...
	result = sp.empty(shape=(len(indexed_teams), iterations + 1))
